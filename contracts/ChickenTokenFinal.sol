...
// ChickenTokenFinal with Governance. Capped at 580,000,000 supply.
contract ChickenTokenFinal is ERC20Capped, AccessControl {
    ...
    function mint(address _to, uint256 _amount) public {
        require(hasRole(MINTER_ROLE, msg.sender), "ChickenToken::mint: not authorized");
        _mint(_to, _amount);
